    ...
    <div id="myapp">
        ...
        <section class="wrapper">
                ...
                <div class="col text-center mb-5">
                    ...
                    <div class="d-flex align-items-baseline justify-content-center text-light p-2 m-2">
                        ...
                        <div class="align-items-baseline d-flex">
                            <p class="mx-1">[{{cart.items.length}}] <template v-if="cart.items.length==1">item</template></p>
            ...
            <div class="row" v-if="!iscartvisible">
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4" v-for="book in books" :key="book.id">
            ...
            <div class="d-flex align-items-baseline justify-content-between p-2 m-2" v-else>
                <h4 class="w-100 text-center text-danger" v-if="cart.items.length==0">Sorry, Add books</h4>
                <table class="table table-bordered table-striped text-center" style="color: azure;" v-else>
                    ...
                    <tbody>
                        <tr v-for="item in cart.items" :key="item.book.id" style="background-color: rgb(227, 179, 34);">
                            <td>{{item.book.id}}</td>
...
export default {
    ...
    methods: {
        ...
        addToCart(book) {
            if (this.cart.items.some(iitem => iitem.book.id === book.id)) {
